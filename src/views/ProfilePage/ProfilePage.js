...
const ProfilePage = () => {
  ...
  const submitProfileHandler = async () => {
    let svc = new RequestSvc();
    let result = await svc.post(`${BASE_URL_API}userProfile`, {
      "IDPersona": iDPersona,
      "Nombre": firstName,
      "Apellido": lastName,
              ...
              <div className="perfilCard">
                ...
                <div className="header">
                  <div className="userImg">
                    <img src={userProfileData?.profile_picture ? userProfileData?.profile_picture : perfilpic} alt="" />
                  </div>
                  <div className="userButtons">
                    <button className="firstBtn">Cambiar foto</button>
                    <br />
                    <button className="secondBtn">Eliminar foto</button>
                  </div>
                </div>
